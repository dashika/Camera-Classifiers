package com.example.dashika.cameraclassifiers.snpe;
    ...
    private void handleModelExtraction(final String modelName, final int modelRawResId) {
        ...
        try {
            ...
            getContentResolver().notifyChange(
                    Uri.withAppendedPath(SNPEModel.MODELS_URI, modelName), null);
        } catch (IOException e) {
            ...
            getContentResolver().notifyChange(SNPEModel.MODELS_URI, null);
        }
    }
