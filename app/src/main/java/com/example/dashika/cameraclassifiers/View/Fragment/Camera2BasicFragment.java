...
import com.example.dashika.cameraclassifiers.View.CameraView.AutoFitTextureView;
...
public class Camera2BasicFragment extends BaseFragment
        implements ActivityCompat.OnRequestPermissionsResultCallback, ICameraOperation {
    ...
    public void onDetach() {
        super.onDetach();
        cameraPresenter.onViewDetached();
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            snpeModel = bundle.getParcelable("SNPEModel");
            cameraPresenter.create(snpeModel, this);
        }
    }
    ...
    public void onResume() {
        super.onResume();
        cameraPresenter.loadNetwork(NeuralNetwork.Runtime.CPU);
    }
...
//        unlockFocus();
    ...
    public static class ErrorDialog extends DialogFragment {
        ...
        public static ErrorDialog newInstance() {
            ...
            args.putString(ARG_MESSAGE, "camera_error");
